...
public class AppConfig extends WebSecurityConfigurerAdapter {
	...
	public Wss4jSecurityInterceptor securityInterceptor() throws Exception {
		...
		securityInterceptor.setSecurementEncryptionParts(
				"{Content}{http://nalogzaprenos.ws.xml.poslovna.bezbednost/}NalogZaPrenosRequest");
	...
	/*
	 * @Bean public Jaxb2Marshaller marshaller() { Jaxb2Marshaller marshaller =
	 * new Jaxb2Marshaller();
	 * marshaller.setContextPath("xws_pi_bezb.Firma.wsdl"); return marshaller; }
	 * 
	 * @Bean public FirmaClient studentClient(Jaxb2Marshaller marshaller) {
	 * FirmaClient client = new FirmaClient();
	 * client.setDefaultUri("http://localhost:9000/ws/NalogZaPrenos.wsdl");
	 * client.setMarshaller(marshaller); client.setUnmarshaller(marshaller);
	 * return client; }
	 */
}
