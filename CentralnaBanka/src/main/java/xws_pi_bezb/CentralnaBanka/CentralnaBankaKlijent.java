...
public class CentralnaBankaKlijent extends WebServiceGatewaySupport {
	...
	public void posaljiMT103(MT103Request request) {
		...
		String uri = "http://localhost:9000/ws/MT103";
		Object o = getWebServiceTemplate().marshalSendAndReceive(uri, request);
		MT103Response response = (MT103Response) o;
		System.out.println("primljen MT103:  " + response.getOdgovor());

	}
	
	public void posaljiMT900(MT900Request request) {
		Jaxb2Marshaller marshaller = new Jaxb2Marshaller();
		marshaller.setClassesToBeBound(MT900Request.class, MT900Response.class);
		setMarshaller(marshaller);
		setUnmarshaller(marshaller);

		String uri = "http://localhost:9000/ws/MT900";
		Object o = getWebServiceTemplate().marshalSendAndReceive(uri, request);
		MT900Response response = (MT900Response) o;
		System.out.println("primljen MT900:  " + response.getOdgovor());

		
	}
	public void posaljiMT910(MT900Request request) {
		Jaxb2Marshaller marshaller = new Jaxb2Marshaller();
		marshaller.setClassesToBeBound(MT900Request.class, MT900Response.class);
		setMarshaller(marshaller);
		setUnmarshaller(marshaller);

		String uri = "http://localhost:9000/ws/MT910";
		Object o = getWebServiceTemplate().marshalSendAndReceive(uri, request);
		MT900Response response = (MT900Response) o;
		System.out.println("primljen MT910:  " + response.getOdgovor());
